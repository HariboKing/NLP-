...
- De app gebruikt SQLite. Voor een demo is dat prima. Voor serieuze productie is later een externe database slimmer.
...
- environment support voor `HOST`, `PORT`, `APP_DATA_DIR`, `APP_DB_PATH`, `APP_UPLOADS_DIR`
